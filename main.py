...
def create_ico_from_png():
    """Функция больше не нужна, так как иконка встроена в BASE64"""
...
""".strip()
    ...
    def _build_cordova(self, mode_internal):
        ...
        # Дополнительно настраиваем Gradle для правильного типа сборки
        if mode_internal == "Unsigned Release APK" or mode_internal == "Signed Release APK":
